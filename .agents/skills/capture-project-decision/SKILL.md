...
description: Capture an accepted rusui design or project outcome in the smallest durable artifact. Use after a Discussion, Issue, or PR resolves a choice that may require an ADR, maintained documentation, example, or reusable Skill.
---
