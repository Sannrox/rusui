...
description: Shape a raw rusui idea, bug report, refactoring proposal, or research question into a focused GitHub Issue. Use when work needs scope, acceptance evidence, risk routing, or a repository-consistent Issue draft before implementation.
---
