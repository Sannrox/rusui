...
[results.md](results.md) is generated by that test. Re-run it to refresh
the snapshot. The scenario clock in the test is fixed; the generated
timestamp is the wall clock of the run.
